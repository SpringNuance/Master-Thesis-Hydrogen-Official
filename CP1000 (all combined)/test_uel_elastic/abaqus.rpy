...
# Run by nguyenb5 on Tue Aug  6 20:18:45 2024
#
...
session.Viewport(name='Viewport: 1', origin=(0.0, 0.0), width=108.84375, 
    height=132.6875)
...
executeOnCaeStartup()
o2 = session.openOdb(name='wedge_elast.odb')
#: Model: C:/LocalUserData/User-data/nguyenb5/CP1000 (all combined)/UEL elastic/wedge_elast.odb
...
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=0, frame=20 )
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=0, frame=20 )
session.viewports['Viewport: 1'].view.setValues(nearPlane=2.49292, 
    farPlane=4.57815, width=2.54174, height=1.17154, viewOffsetX=0.163575, 
    viewOffsetY=-0.035045)
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=0, frame=0 )
