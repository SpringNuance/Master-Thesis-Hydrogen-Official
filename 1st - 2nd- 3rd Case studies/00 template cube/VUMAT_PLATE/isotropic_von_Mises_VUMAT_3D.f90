...
module common_block
    ...
    integer, parameter :: r_heat_idx = 5
...
! Write only (modifiable) variables -
    ...
    ! properties
    DL       =     props(1)    ! m^2/s                   Latice Diffusivity
    VH       =     props(2)    ! m^3/mol                 Molar Volume of Hydrogen
    R        =     props(3)    ! (N) / mol·K             Gas Constant
    T        =     props(4)    ! K                       Temperature
    NL       =     props(5)    ! 1/m^3                   Density of Latice Sites
    CL0      =     props(6)    ! 1/m^3                   CL Coundry
    mu0_L    =     props(7)    ! Nm/mol                  Referance Chemical Potential in Latice Sites
