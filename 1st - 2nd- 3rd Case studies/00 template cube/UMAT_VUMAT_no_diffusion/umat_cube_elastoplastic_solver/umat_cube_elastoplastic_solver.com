...
options = {
    ...
    'unfold_param':OFF,
    'unsymm':OFF,
<<<<<<<< HEAD:_CURRENT WORK MERT_/UMAT_VUMAT_no_diffusion/umat_cube_elastoplastic_solver/umat_cube_elastoplastic_solver.com
    'verbose':1,
========
    'user':'pure_diffusion_trap.f90',
    'verbose':2,
>>>>>>>> 97b401025cd658606babef2a68c6e1f4b44b5f60:06 enHill48 with H2 diffusion/hydrogen_diffusion_BC/CP1000_steel_trap/CP1000_diffusion_post.com
    'visco':OFF,
    'xplSelect':OFF,
}
