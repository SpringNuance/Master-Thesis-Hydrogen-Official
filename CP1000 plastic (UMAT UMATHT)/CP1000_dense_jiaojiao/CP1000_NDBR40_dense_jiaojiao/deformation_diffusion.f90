...
module common_block
    ...
    ! NDBR40   | 121675      | 136858      !
    ! SH115    | 121510      | 137643      !
    ! **************************************

    integer, parameter :: total_elems = 121675 ! Storing the actual number of elements
    integer, parameter :: total_nodes = 136858 ! Storing the actual number of nodes
