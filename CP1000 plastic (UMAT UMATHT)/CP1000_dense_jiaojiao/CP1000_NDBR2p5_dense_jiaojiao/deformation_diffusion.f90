...
module common_block
    ...
    integer, parameter :: total_elems = 121346 ! Storing the actual number of elements
    integer, parameter :: total_nodes = 141488 ! Storing the actual number of nodes
