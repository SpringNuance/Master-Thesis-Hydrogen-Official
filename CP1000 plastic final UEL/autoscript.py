...
def main():
    ...
    parser.add_argument('--geometry', type=str, required=True, help='Geometry string argument')
    ...
    output_simulation_path = f'CP1000_{geometry}_sim'
    inp_file_name = f'CP1000_{geometry}_geometry'

    combined_original_inp_path = os.path.join(original_inp_file_path, f"{inp_file_name}.inp")
    combined_UEL_inp_path = os.path.join(output_simulation_path, f"{inp_file_name}_UEL.inp")
    ...
    geometry_path_excel = f"properties_{geometry}.xlsx"
