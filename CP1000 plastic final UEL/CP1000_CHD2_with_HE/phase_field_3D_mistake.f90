...
module common_block
    ...
    integer :: nelem ! Number of actual elements
...
subroutine UEXTERNALDB(lop,lrestart,time,dtime,kstep,kinc)
    ...
    if (lop == 0) then 
        ...
        ! Count the number of lines (or number of elements)
        do
            read(10, '(A)', IOSTAT=iostat) line
            if (iostat /= 0) exit  ! End of file or error
            nelem = nelem + 1
            print *, 'Element ID: ', nelem
        end do
        ...
        print *, 'Number of elements (lines) in file: ', nelem
