...
import blockForm, blockProcedure
import beamReportForm,beamAnalysisForm
import datumProcedure
...
class PrototypeToolsetGui(AFXToolsetGui):
    ...
    def __init__(self):
        ...
        self.blockForm = blockForm.BlockForm(self)
        self.blockProcedure = blockProcedure.BlockProcedure(self)
        self.beamReportForm = beamReportForm.BeamReportForm(self)
        self.beamAnalysisForm = beamAnalysisForm.BeamAnalysisForm(self)
        self.datumProcedure = datumProcedure.DatumProcedure(self)
