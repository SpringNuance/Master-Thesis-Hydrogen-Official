...
from appIcons_ans import formIconData, dialogIconData
import testForm_ans
...
class WidgetToolsetGui(AFXToolsetGui):
    ...
    def __init__(self):
        ...
        FXMAPFUNC(self, SEL_COMMAND, self.ID_FORM, WidgetToolsetGui.onCmdForm)
      
        self.form = testForm_ans.TestForm(self)
