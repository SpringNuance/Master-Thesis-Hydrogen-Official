...
mdb.models.changeKey(fromName='Model-1', toName='NF1')
m = mdb.models['NF1']
a = m.rootAssembly
session.viewports['Viewport: 1'].setValues(displayedObject=a)
...
m.FrequencyStep(
    name='FREQUENCY',
    previous='Initial', 
    description='The extraction of the first 30 modes of the circuit board', 
    normalization=MASS,
    simLinearDynamics=OFF,
    numEigen=30)

m.steps['FREQUENCY'].Restart(frequency=1)
...
region = a.sets['BASE-L-M']
m.DisplacementBC(name='BC-LEFT', createStepName='Initial', 
    region=region, u1=SET, u2=SET, u3=SET, ur1=SET, ur2=SET, ur3=SET)

region = a.sets['BASE-R-M']
m.DisplacementBC(name='BC-RIGHT', createStepName='Initial', 
    region=region, u1=SET, u2=SET, u3=SET, ur1=SET, ur2=SET, ur3=SET)

mdb.saveAs(
    pathName='circuitBoard-random')
