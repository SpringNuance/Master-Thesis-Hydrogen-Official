...
s = mdb.models['builtIn'].ConstrainedSketch(name='__profile__', sheetSize=10.0)
...
mdb.models['builtIn'].materials['builtInMat'].Elastic(table=((30000000.0, 0.3), ))
...
mdb.models['userMat'].materials['userMat'].UserMaterial(mechanicalConstants=(
    30000000.0, 0.3, 30000.0, 0.0, 50000.0, 0.2, 1.0
    ))
